![image](https://user-images.githubusercontent.com/60838780/113682878-30378c00-96f6-11eb-91b9-b6fb7a5ffa67.png)这就是自己重写数据结构，为其添加遍历方法的写法，分为几下几步
...
***
### 链表结点位置改变时如何标记链表
【1】使用一个空的结点指向该链表的第一个有效结点，这个空结点就是标记链表的结点，以后调用链表的时候就调用这个链表的next即可  
