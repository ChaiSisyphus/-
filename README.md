...
![image](https://user-images.githubusercontent.com/60838780/114840532-79c85b00-9e09-11eb-9083-a123d449c400.png)  
【1】每次在函数执行开始时，对返回值进行清零然后再运算，这样保证每次返回的只是当前单次获得结果。采用一个全局变量无返回值递归，每次递归时获得单次运算的值也可以获得相同的效果  
