...
![image](https://user-images.githubusercontent.com/60838780/113713734-40f9f900-971a-11eb-83a6-8375356e33c3.png)【1】这种多态的形式称为**父类引用**指向子类对象，通过引用类型直接定义的变量称为引用，new出来的都称为对象。
